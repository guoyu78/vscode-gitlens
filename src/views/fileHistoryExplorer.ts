...
export class FileHistoryExplorer extends Disposable implements TreeDataProvider<ExplorerNode> {
    ...
    async dock(switchView: boolean = true, updateConfig: boolean = true) {
        ...
        await setCommandContext(CommandContext.FileHistoryExplorer, false);
        if (updateConfig) {
    ...
    async undock(switchView: boolean = true, updateConfig: boolean = true) {
        ...
        await setCommandContext(CommandContext.FileHistoryExplorer, this.config.location);
        if (updateConfig) {
    ...
    private async getRootNode(editor: TextEditor | undefined): Promise<FileHistoryNode | undefined> {
